...
/* ------------------------------------------------------------------ ERAS -- */
G.ERAS = [
  { id: "e0", label: "Age of Walpole & Pitt",     years: "1721–1832",    defaultOff: true },
...
G.PARTIES = {
  ...
  "SDP":               { label: "SDP",               lineage: "Liberal",      colour: "#cb4f7d", cap: 632 },
  "Workers Party":     { label: "Workers Party",     lineage: "Independent",  colour: "#8b0000", cap: 632 },
  /* --- Northern Ireland --- */
  "DUP":               { label: "DUP",               lineage: "DUP",          colour: "#d46a4c", cap: 18 },
  "UUP":               { label: "UUP",               lineage: "UUP",          colour: "#48a5ee", cap: 18 },
  "SDLP":              { label: "SDLP",              lineage: "SDLP",         colour: "#4ea268", cap: 18 },
  "Sinn Féin":         { label: "Sinn Féin",         lineage: "SinnFein",     colour: "#326760", cap: 18 },
  "Alliance":          { label: "Alliance",          lineage: "Alliance",     colour: "#f6cb2f", cap: 18 },
  "TUV":               { label: "TUV",               lineage: "TUV",          colour: "#0c3a6a", cap: 18 },
  /* --- the Fringe: joke candidates and internet insurgents (all real) --- */
  "Monster Raving Loony": { label: "Monster Raving Loony", lineage: "Fringe", colour: "#ff5fa2", cap: 632 },
  "Independent (Fringe)": { label: "Independent",    lineage: "Fringe",       colour: "#b06fc9", cap: 632 },
  /* --- Wildcard groups --- */
...
G.LEANS = {
  ...
  /* the NI parties live and die in NI (everywhere else: a steep hill, not a wall) */
  DUP:         { NI:  2.5 }, UUP: { NI: 2.3 }, SDLP: { NI: 2.3 }, SinnFein: { NI: 2.5 },
  Alliance:    { NI:  2.2 }, TUV: { NI: 1.7 },
  /* the Fringe fights everywhere and is loved nowhere in particular */
  Fringe:      { SCO: -0.4, WAL: -0.3, NE: -0.2, NW: -0.2, YH: -0.2, EM: -0.3, WM: -0.3, EE: -0.3, LDN: 0.1, SE: -0.3, SW: -0.2 }
};
...
G.POLITICIANS = [
  ...
  P("Suella Braverman",   "Reform UK",    "e7", ["home","justice"],         [52,58,62,50,48], "Twice Home Secretary; defected from Conservatives to Reform UK January 2026."),
  ...
  P("Robert Jenrick",     "Reform UK",    "e7", ["home","justice","chancellor"], [58,64,68,60,58], "Former Tory leadership contender; defected to Reform UK January 2026, appointed shadow Chancellor."),
  P("Nadhim Zahawi",      "Reform UK",    "e7", ["chancellor","education","business"], [54,66,58,56,52], "Former Chancellor and Education Secretary; defected from Conservatives to Reform UK January 2026."),
  P("Kemi Badenoch",      "Conservative", "e7", ["business","leader","education"], [58,64,68,62,58], "Conservative leader from 2024; fighting defections to Reform UK including Braverman, Jenrick and Zahawi."),
  /* Labour (incl. current government) */
  P("Keir Starmer",       "Labour",       "e7", ["pm","justice"],           [54,64,58,66,60], "PM 2024–June 2026; won landslide then resigned after Labour's 2026 local election collapse and Reform surge."),
  P("Andy Burnham",       "Labour",       "e7", ["pm","health","home","leader"], [80,78,82,76,74], "Mayor of Greater Manchester 2017–26; won Makerfield June 2026, sole candidate to succeed Starmer as Labour leader and PM."),
  P("Rachel Reeves",      "Labour",       "e7", ["chancellor"],             [52,62,58,64,58], "First female Chancellor; caretaker as Starmer government winds down."),
  P("Yvette Cooper",      "Labour",       "e7", ["foreign","home"],         [58,80,66,72,62], "Foreign Secretary from 2026; was among Cabinet voices who pressed Starmer to resign."),
  P("Shabana Mahmood",    "Labour",       "e7", ["home","justice"],         [56,66,64,68,62], "Home Secretary from 2026; also pressed Starmer to go, widely tipped for a senior Burnham cabinet role."),
  P("David Lammy",        "Labour",       "e7", ["foreign","justice","deputy"], [62,70,76,64,58], "First Foreign Secretary; replaced by Yvette Cooper in cabinet reshuffle."),
  P("Angela Rayner",      "Labour",       "e7", ["deputy","home"],          [68,60,74,58,66], "Deputy PM and Housing Secretary; resigned as deputy Labour leader October 2025."),
  P("Wes Streeting",      "Labour",       "e7", ["health","chancellor","leader"], [64,60,76,64,60], "Health Secretary who resigned May 2026 triggering Starmer's fall; endorsed Burnham and tipped for Chancellor."),
  P("Lucy Powell",        "Labour",       "e7", ["deputy","whip","leader"], [60,64,68,62,64], "Deputy Labour leader from October 2025 after defeating Phillipson; Commons Leader under Starmer."),
  P("Bridget Phillipson", "Labour",       "e7", ["education"],              [54,58,62,60,56], "Education Secretary; lost deputy leadership contest to Lucy Powell in October 2025."),
  P("John Healey",        "Labour",       "e7", ["defence"],                [50,70,58,64,58], "Defence Secretary; long-serving frontbencher."),
  P("Pat McFadden",       "Labour",       "e7", ["business","whip"],        [48,74,58,70,66], "Cabinet Office minister and Starmer's campaign coordinator."),
  P("Ed Miliband",        "Labour",       "e7", ["leader","business"],      [54,68,66,62,56], "Labour leader 2010–15; Energy and Net Zero Secretary."),
  P("Clive Lewis",        "Labour",       "e7", ["defence","business","leader"], [56,52,70,56,48], "Left-wing Labour MP; former shadow defence and business spokesman."),
  /* Liberal Democrat */
  P("Ed Davey",           "Liberal Democrat","e7", ["leader","deputy","business"], [60,72,64,66,60], "Lib Dem leader; surged in 2024 election to 72 seats."),
  P("Vince Cable",        "Liberal Democrat","e7", ["business","chancellor","leader"], [56,70,66,68,56], "Coalition Business Secretary and later Lib Dem leader."),
  P("Nick Clegg",         "Liberal Democrat","e7", ["deputy"],              [60,64,74,64,56], "Deputy PM in the 2010 coalition; now a tech executive."),
  P("Layla Moran",        "Liberal Democrat","e7", ["leader","foreign","health"], [62,60,68,62,60], "Lib Dem foreign affairs spokesperson and leadership contender; Palestinian heritage."),
  /* SNP */
  P("Nicola Sturgeon",    "SNP",          "e7", ["pm","leader"],            [72,76,82,76,74], "Long-serving First Minister and SNP leader."),
  P("Alex Salmond",       "SNP",          "e7", ["pm","leader"],            [70,76,84,74,64], "First Minister; brought the SNP to power, later led Alba Party."),
  P("John Swinney",       "SNP",          "e7", ["pm","chancellor","leader"], [56,76,62,68,66], "First Minister from 2024; long-time SNP deputy and finance chief."),
  P("Humza Yousaf",       "SNP",          "e7", ["pm","health","leader"],   [54,62,64,56,52], "Briefly First Minister 2023–24; resigned after confidence vote."),
  P("Stephen Flynn",      "SNP",          "e7", ["leader"],                 [58,54,72,56,58], "SNP Westminster leader; Aberdeen MP."),
  P("Kate Forbes",        "SNP",          "e7", ["chancellor","deputy"],    [60,60,66,68,58], "Deputy First Minister; strong leadership candidate in 2023."),
  P("Ash Regan",          "SNP",          "e7", ["home","leader"],          [52,54,60,54,52], "Former SNP minister who defected to Alba Party; leadership candidate 2023."),
  /* Plaid Cymru */
  P("Adam Price",         "Plaid Cymru",  "e7", ["leader"],                 [58,58,76,60,56], "Former Plaid Cymru leader."),
  P("Leanne Wood",        "Plaid Cymru",  "e7", ["leader"],                 [58,54,68,56,54], "Former Plaid Cymru leader."),
  P("Rhun ap Iorwerth",   "Plaid Cymru",  "e7", ["leader"],                 [56,58,66,60,60], "Plaid Cymru leader; First Minister of Wales from 2024 coalition."),
  /* Reform UK */
  P("Nigel Farage",       "Reform UK",    "e7", ["leader","foreign","business"], [82,62,90,50,58], "Reform UK leader; won 1,451 council seats in May 2026 local elections and now has 8 MPs; dominant figure in British politics."),
  P("Richard Tice",       "Reform UK",    "e7", ["business","deputy","leader"], [56,52,66,52,58], "Reform UK deputy leader and MP for Boston & Skegness."),
  P("Zia Yusuf",          "Reform UK",    "e7", ["business","home","whip"],  [52,48,60,58,54], "Reform UK chairman and policy architect."),
  P("Lee Anderson",       "Reform UK",    "e7", ["whip","leader"],           [58,46,64,44,52], "Reform UK chief whip; former Tory MP and deputy chair."),
  P("Ben Habib",          "Reform UK",    "e7", ["business"],                [46,46,58,52,44], "Reform UK former deputy leader."),
  P("Rupert Lowe",        "Reform UK",    "e7", ["business","home","leader"], [52,48,60,50,46], "MP for Great Yarmouth; launched brief breakaway 'Restore Britain' before return to Reform fold."),
  P("Paul Nuttall",       "Reform UK",    "e7", ["leader","deputy"],         [44,48,58,46,48], "Former UKIP leader; on the Reform UK bench."),
  /* Green */
  P("Caroline Lucas",     "Green",        "e7", ["leader","education"],      [64,66,76,64,62], "Green Party's first MP; held Brighton Pavilion 2010–24."),
  P("Carla Denyer",       "Green",        "e7", ["leader","business"],       [56,52,68,56,56], "Green Party co-leader and MP for Bristol Central."),
  P("Adrian Ramsay",      "Green",        "e7", ["leader"],                  [50,50,62,54,56], "Green Party co-leader and MP for Waveney Valley."),
  P("Zack Polanski",      "Green",        "e7", ["leader"],                  [60,50,74,56,56], "Green Party leader from 2025; 'eco-populist' Assembly Member."),
  P("Natalie Bennett",    "Green",        "e7", ["leader"],                  [48,52,58,52,54], "Former Green Party leader; now a peer."),
  P("Sian Berry",         "Green",        "e7", ["leader","home"],           [54,52,64,56,54], "Former Green Party co-leader; London Assembly Member."),
  /* Your Party */
  P("Jeremy Corbyn",      "Your Party",   "e7", ["leader","foreign"],        [62,78,68,54,40], "Former Labour leader; co-founded the left-wing Your Party in 2025."),
  P("Zarah Sultana",      "Your Party",   "e7", ["leader"],                  [58,46,70,48,42], "Co-founder of Your Party; MP for Coventry South."),
  P("Andrew Feinstein",   "Your Party",   "e7", ["defence","foreign"],       [52,54,60,52,46], "Former ANC MP turned anti-arms campaigner; ran against Starmer in Holborn in 2024."),
...
/* ===================== 2024 PARLIAMENT ROSTER (scope: "p24") =============
   A SEEDED set of real, well-known figures from the 2024 general election, used
   by the "2024 Parliament" game mode. This is a starting sample — the full field
   is meant to be filled via the editable politicians sheet (rows tagged mode
   "parl2024"), which the game merges in at load. Party affiliations reflect 2024:
   note Jeremy Corbyn sat as an INDEPENDENT and Zarah Sultana as LABOUR that year
   (a nuance the historical modes handle differently). Stats are gameplay values,
   not judgements of real people; inclusion is not endorsement. */
G.ERA_BY_ID["e24"] = { id: "e24", label: "2024 Parliament", years: "2024\u2013" };
G.ROSTER_2024 = [
  /* Labour (the 2024 government) */
  P("Keir Starmer",        "Labour",            "e24", ["pm","leader","justice"],     [58,72,60,80,62], "Led Labour to 2024 landslide; resigned as PM June 2026 after Reform surge and by-election loss.", "p24"),
  P("Rachel Reeves",       "Labour",            "e24", ["chancellor","business"],     [56,72,60,76,58], "First female Chancellor 2024–26; oversaw difficult economic environment and welfare cuts.", "p24"),
  P("Angela Rayner",       "Labour",            "e24", ["deputy","home","leader"],     [72,62,68,62,70], "Deputy PM and Housing Secretary; resigned as deputy Labour leader October 2025, stayed in cabinet.", "p24"),
  P("Andy Burnham",        "Labour",            "e24", ["pm","leader","health","home"], [82,80,84,78,76], "Former Manchester Mayor; won Makerfield by-election June 2026, sole candidate to lead Labour and become PM.", "p24"),
  P("Wes Streeting",       "Labour",            "e24", ["health","chancellor","leader"], [66,62,74,64,60], "Health Secretary who resigned May 2026 triggering leadership crisis; Burnham's closest ally, tipped as next Chancellor.", "p24"),
  P("Yvette Cooper",       "Labour",            "e24", ["foreign","home"],             [60,78,64,74,62], "Home Secretary 2024–26, then Foreign Secretary; among Cabinet voices who pressed Starmer to go.", "p24"),
  P("Shabana Mahmood",     "Labour",            "e24", ["justice","home"],             [58,66,64,70,60], "Justice then Home Secretary; pushed Starmer to resign, widely tipped for senior role under Burnham.", "p24"),
  P("Lucy Powell",         "Labour",            "e24", ["deputy","leader","whip"],     [62,66,68,62,66], "Deputy Labour leader from October 2025, defeating Phillipson; Leader of the House under Starmer.", "p24"),
  P("David Lammy",         "Labour",            "e24", ["foreign","justice"],          [64,68,74,66,60], "First Foreign Secretary in Starmer government; replaced by Yvette Cooper in reshuffle.", "p24"),
  P("John Healey",         "Labour",            "e24", ["defence","business"],         [52,72,56,70,58], "Defence Secretary 2024–26.", "p24"),
  P("Bridget Phillipson",  "Labour",            "e24", ["education","chancellor"],     [56,62,62,66,56], "Education Secretary; lost deputy leadership contest to Lucy Powell October 2025.", "p24"),
  P("Jonathan Reynolds",   "Labour",            "e24", ["business","chancellor"],      [56,62,60,66,56], "Business and Trade Secretary from 2024.", "p24"),
  P("Ed Miliband",         "Labour",            "e24", ["environment","leader"],       [58,76,66,66,54], "Energy Security and Net Zero Secretary; former Labour leader 2010–15.", "p24"),
  P("Liz Kendall",         "Labour",            "e24", ["work","health"],              [54,62,58,64,54], "Work and Pensions Secretary from 2024.", "p24"),
  P("Pat McFadden",        "Labour",            "e24", ["whip","leader","business"],   [50,74,58,72,68], "Cabinet Office minister and Starmer's campaign coordinator.", "p24"),
  P("Zarah Sultana",       "Your Party",        "e24", ["culture","education"],        [62,44,68,50,46], "Elected for Coventry South as Labour in 2024; co-founded Your Party with Corbyn.", "p24"),
  /* Conservatives (the 2024 opposition) */
  P("Rishi Sunak",         "Conservative",      "e24", ["pm","chancellor"],            [56,68,60,72,56], "Prime Minister who called and lost the 2024 election.", "p24"),
  P("Jeremy Hunt",         "Conservative",      "e24", ["chancellor","foreign","health"],[54,76,58,74,56], "Former Chancellor and Foreign and Health Secretary.", "p24"),
  P("Kemi Badenoch",       "Conservative",      "e24", ["business","leader"],          [60,62,68,62,60], "Conservative leader from 2024; battling Reform UK defections — Braverman, Jenrick and Zahawi all left.", "p24"),
  P("Robert Jenrick",      "Reform UK",         "e24", ["home","justice","chancellor"], [60,64,70,62,60], "Tory leadership runner-up; defected to Reform UK January 2026, appointed their shadow Chancellor.", "p24"),
  P("Suella Braverman",    "Reform UK",         "e24", ["justice","home"],             [54,58,62,52,50], "Former Home Secretary; defected from Conservatives to Reform UK January 2026.", "p24"),
  P("Nadhim Zahawi",       "Reform UK",         "e24", ["chancellor","education"],     [54,66,58,56,52], "Former Chancellor; defected to Reform UK January 2026.", "p24"),
  P("James Cleverly",      "Conservative",      "e24", ["foreign","home"],             [58,64,62,64,58], "Former Foreign Secretary and Home Secretary.", "p24"),
  P("Priti Patel",         "Conservative",      "e24", ["home","defence"],             [52,64,56,58,56], "Former Home Secretary.", "p24"),
  /* Other parties */
  P("Ed Davey",            "Liberal Democrat",  "e24", ["deputy","leader","business"], [62,68,60,64,62], "Liberal Democrat leader; won 72 seats in 2024 election, the party's best result in a century.", "p24"),
  P("Layla Moran",         "Liberal Democrat",  "e24", ["foreign","health","leader"],  [64,60,68,62,60], "Lib Dem foreign affairs spokesperson; Palestinian heritage, powerful voice on Gaza.", "p24"),
  P("Nigel Farage",        "Reform UK",         "e24", ["leader","foreign"],           [84,62,90,52,60], "Reform UK leader; 8 MPs and 1,451 council seats in May 2026 — transformed British politics.", "p24"),
  P("Richard Tice",        "Reform UK",         "e24", ["business","deputy","leader"], [56,52,66,52,58], "Reform UK deputy leader, MP for Boston & Skegness.", "p24"),
  P("Carla Denyer",        "Green",             "e24", ["environment","leader"],       [58,50,64,54,56], "Green Party co-leader, MP for Bristol Central.", "p24"),
  P("Adrian Ramsay",       "Green",             "e24", ["environment","business"],     [52,50,56,54,54], "Green Party co-leader, MP for Waveney Valley.", "p24"),
  P("Zack Polanski",       "Green",             "e24", ["leader","culture"],           [60,50,74,56,56], "Green Party leader from 2025; London Assembly Member.", "p24"),
  P("John Swinney",        "SNP",               "e24", ["pm","leader","chancellor"],   [58,76,62,68,68], "First Minister of Scotland from 2024.", "p24"),
  P("Stephen Flynn",       "SNP",               "e24", ["leader","foreign"],           [60,56,68,58,58], "SNP Westminster leader.", "p24"),
  P("Rhun ap Iorwerth",    "Plaid Cymru",       "e24", ["leader","home"],              [58,58,66,60,60], "Plaid Cymru leader and First Minister of Wales.", "p24"),
  /* The independent note the brief calls out */
  P("Jeremy Corbyn",       "Independent",       "e24", ["leader","foreign","justice"], [60,72,66,58,46], "Re-elected for Islington North in 2024 as an Independent; co-founded Your Party in 2025.", "p24")
];
Array.prototype.push.apply(G.POLITICIANS, G.ROSTER_2024);
...
G.isDespot = function (p) { return !!p && (p.party === "Dictators" || !!G.DESPOT_EXTRA[p.name] || !!p.despot); };
G.DESPOT_SPECTRUM = {
...
G.CONFIG = {
  ...
  despotUnityChance:   0,      // DESPOTS ARE WILDCARD-ONLY (never in unity)
  ...
  /* random opposition front benches: every rival party fields its own randomly
     drafted cabinet each game; its quality scales its share of the seats you
     lose and the pressure it puts on you. Kept in a tight band so it flavours,
     never decides, the result. */
  oppStrengthMin: 0.82,
  oppStrengthMax: 1.18,
  oppPressure: 1.1,       // logit shift per point of average rival strength above 1.0
...
/* ====================================================== ALIGNMENT (v5) ==== */
/* A small left–right spectrum used by the custom-party setup and the
   coalition logic. Positions are numeric: -2 left … 0 centre … +2 right.
   An editorial abstraction, like the ratings — argue by editing it. */
G.ALIGNMENTS = [
  { key: "left",         label: "Left",         value: -2 },
  { key: "centre-left",  label: "Centre-left",  value: -1 },
  { key: "centre",       label: "Centre",       value:  0 },
  { key: "centre-right", label: "Centre-right", value:  1 },
  { key: "right",        label: "Right",        value:  2 }
];
G.ALIGN_BY_KEY = Object.fromEntries(G.ALIGNMENTS.map(function (a) { return [a.key, a]; }));
G.alignValue = function (key) { var a = G.ALIGN_BY_KEY[key]; return a ? a.value : 0; };
G.alignLabel = function (key) { var a = G.ALIGN_BY_KEY[key]; return a ? a.label : "Centre"; };

/* where each party label sits on that spectrum (for coalition chemistry) */
G.PARTY_ALIGN = {
  "Labour": -1, "Green": -1.5, "SNP": -1, "Plaid Cymru": -1, "Your Party": -2,
  "SDLP": -1, "Sinn Féin": -1.5, "Alliance": 0, "Liberal Democrat": -0.25,
  "Liberal": -0.25, "Whig": -0.25, "Independent": 0,
  "Conservative": 1.25, "Reform UK": 2, "UKIP": 2, "Brexit Party": 2,
  "Restore Britain": 2, "DUP": 1.75, "UUP": 1.25, "TUV": 2,
  "US Democrat": -1, "US Republican": 1.5, "World Leaders": 0,
  "SDP": -0.25, "Workers Party": -2, "Monster Raving Loony": 0, "Independent (Fringe)": 0,
  "Revolutionaries": -1.5, "Dictators": 2
};
G.partyAlignValue = function (label) {
  return (label in G.PARTY_ALIGN) ? G.PARTY_ALIGN[label] : 0;
};
/* a Dynasty ticket inherits its lineage's politics */
G.LINEAGE_ALIGN = {
  Labour: -1, Green: -1.5, SNP: -1, Plaid: -1, YourParty: -2,
  Liberal: -0.25, Independent: 0, Fringe: 0, Alliance: 0,
  SDLP: -1, SinnFein: -1.5, UUP: 1.25, DUP: 1.75, TUV: 2,
  Conservative: 1.25, Reform: 2, Restore: 2
};

/* a mild left/right colouring of the regions, used ONLY to tilt a custom
   ticket's regional appeal a touch (CONFIG.alignTiltScale). Negative regions
   are friendlier to the left, positive to the right. */
G.REGION_TILT = {
  SCO: -0.5, WAL: -0.5, NI: 0, NE: -0.7, NW: -0.5, YH: -0.3, EM: 0.5,
  WM: 0.2, EE: 0.7, LDN: -0.7, SE: 0.8, SW: 0.4
};

/* curated custom-party palette — picked to stay clear of the real parties'
   colours above (no Tory blue, Labour red, Lib Dem amber, Reform cyan, SNP
   yellow, Plaid/Green green, UKIP purple). */
G.PARTY_PALETTE = [
  { key: "green",   label: "Racing Green", colour: "#2f5d3a" },
  { key: "brass",   label: "Brass",        colour: "#b3862f" },
  { key: "oxblood", label: "Oxblood",      colour: "#862231" },
  { key: "rose",    label: "Rose",         colour: "#c2477f" },
  { key: "teal",    label: "Deep Teal",    colour: "#0e6b63" },
  { key: "copper",  label: "Copper",       colour: "#8a5a2b" }
];
G.paletteColour = function (key) {
  for (var i = 0; i < G.PARTY_PALETTE.length; i++) if (G.PARTY_PALETTE[i].key === key) return G.PARTY_PALETTE[i].colour;
  return null;
};
/* the default bloc identity for each customisable mode (used when skipped) */
G.defaultCustom = function (mode) {
  if (mode === "wildcard")  return { name: "Your cabinet",      align: "centre", colour: "#b3862f" };
  if (mode === "parl2024")  return { name: "Your 2024 ticket",  align: "centre", colour: "#b3862f" };
  return { name: "Your unity ticket", align: "centre", colour: "#2f5d3a" };
};

/* ====================================================== CASTS (v6) ======== */
/* Orthogonal to eras: WHO is allowed to walk into the draft. Statesmen are
   always in; insiders (SpAds, strategists, mandarins) and the novelty fringe
   (joke candidates and internet insurgents — all of whom really stood, plus a
   couple of flagged conspiracists) are toggles. Dynasty ignores the toggles:
   a dynasty IS its whole bench. */
G.CASTS = [
  { key: "statesman", label: "Statesmen & stateswomen", locked: true,  on: true },
  { key: "insider",   label: "SpAds & insiders",        locked: false, on: true },
  { key: "novelty",   label: "Mavericks & meme candidates", locked: false, on: false }
];
G.castOf = function (p) { return (p && p.cast) || "statesman"; };

/* flagged figures: included as historical fact, never endorsement — shown
   with a plain warning (like the despots) and a mild credibility penalty. */
G.FLAG_EXTRA = {};
G.isFlagged = function (p) { return !!p && (!!p.flag || !!G.FLAG_EXTRA[p.name]); };
G.flagLabel = function (p) {
  var f = (p && p.flag) || G.FLAG_EXTRA[p && p.name];
  return f === "conspiracist" ? "conspiracist" : (f ? String(f) : "");
};

/* photo overrides: exact Wikipedia titles (when the display name isn't the
   article title) and direct image URLs. The portrait chain is
   img → wiki title → name → monogram, so something always renders. */
G.PHOTO = {
  "Lord Palmerston": { wiki: "Henry John Temple, 3rd Viscount Palmerston" },
  "Lord John Russell": { wiki: "John Russell, 1st Earl Russell" },
  "Earl of Derby": { wiki: "Edward Smith-Stanley, 14th Earl of Derby" },
  "Lord Aberdeen": { wiki: "George Hamilton-Gordon, 4th Earl of Aberdeen" },
  "Lord Salisbury": { wiki: "Robert Gascoyne-Cecil, 3rd Marquess of Salisbury" },
  "Screaming Lord Sutch": { wiki: "Screaming Lord Sutch" },
  "Howling Laud Hope": { wiki: "Howling Laud Hope" },
  "Count Binface": { wiki: "Count Binface" },
  "Lord Buckethead": { wiki: "Lord Buckethead" }
};
