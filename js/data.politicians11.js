...
(function () {
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════ */
  I("Dianne Feinstein",       "Democrat","e6",["pm","justice","home","leader"],             [58,72,55,58,55], "Democrat California Senator longest-serving; gun control; intel committee; died aged 90");
  I("Barbara Boxer",          "Democrat","e6",["pm","environment","leader"],                 [56,65,55,55,52], "Democrat California Senator; environment and foreign policy; liberal lioness");
  I("Patrick Leahy",          "Democrat","e5",["pm","justice","leader","agriculture"],       [55,72,52,55,55], "Democrat Vermont Senator; president pro tempore; Leahy Law; longest-serving");
  I("Carl Levin",             "Democrat","e5",["pm","defence","leader","justice"],           [58,68,55,58,55], "Democrat Michigan Senator; Armed Services; Wall Street reform; Carl Levin Institute");
  I("Ted Stevens",            "Republican","e5",["pm","trade","defence","leader"],           [52,70,50,52,52], "Republican Alaska Senator; pork barrel champion; Ted-net bridge to nowhere");
  I("Orrin Hatch",            "Republican","e5",["pm","justice","health","leader"],          [52,72,50,52,52], "Republican Utah Senator 42 years; Judiciary; CHIP; LDS leadership");
  I("Bob Bennett",            "Republican","e6",["pm","chancellor","leader"],                [52,60,50,52,50], "Republican Utah Senator; primary victim of Tea Party 2010");
  I("Richard Lugar",          "Republican","e5",["pm","foreign","agriculture","leader"],     [58,70,55,58,55], "Republican Indiana Senator; Nunn-Lugar; nuclear disarmament; farm bill");
  I("Sam Nunn",               "Democrat","e5",["pm","defence","foreign","leader"],           [60,68,58,60,58], "Democrat Georgia Senator; defence authority; nuclear threat initiative");
  I("Lloyd Bentsen",          "Democrat","e5",["pm","chancellor","trade","leader"],          [60,65,60,60,58], "Democrat Texas Senator; VP candidate 1988; 'Senator you're no Jack Kennedy'");
  I("Fritz Hollings",         "Democrat","e5",["pm","trade","commerce","leader"],            [55,68,55,55,52], "Democrat South Carolina Senator; Gramm-Rudman-Hollings deficit act");
  I("Daniel Patrick Moynihan","Democrat","e5",["pm","foreign","work","leader"],              [65,65,65,62,58], "Democrat New York Senator; UN Ambassador; welfare reform analyst; sociologist-politician");
  I("Bill Bradley",           "Democrat","e6",["pm","chancellor","leader","foreign"],        [60,60,58,58,52], "Democrat basketball star Senator; 2000 presidential candidate; tax reform");
  I("Paul Wellstone",         "Democrat","e6",["pm","work","leader","education"],            [62,55,65,55,55], "Democrat Minnesota Senator; 'the conscience of the Senate'; died plane crash 2002");
  I("Byron Dorgan",           "Democrat","e6",["pm","energy","agriculture","leader"],        [55,62,52,52,52], "Democrat North Dakota Senator; bank warnings pre-2008; prairie populist");
  I("Kent Conrad",            "Democrat","e6",["pm","chancellor","agriculture","leader"],    [52,62,50,52,52], "Democrat North Dakota Senator; budget deficit hawk; gang-of-six");
  I("Tim Johnson",            "Democrat","e6",["pm","leader","agriculture","chancellor"],    [50,60,48,50,50], "Democrat South Dakota Senator; survived brain hemorrhage 2006; returned");
  I("Ben Nelson",             "Democrat","e7",["pm","leader","chancellor","health"],         [50,60,48,50,50], "Democrat Nebraska Senator; Cornhusker Kickback on ACA; insurance background");
  I("Blanche Lincoln",        "Democrat","e7",["pm","agriculture","leader"],                 [50,55,48,50,48], "Democrat Arkansas Senator; first woman to chair Ag Committee; lost 2010 primary");
  I("Mark Pryor",             "Democrat","e7",["pm","leader","health"],                      [50,55,48,50,48], "Democrat Arkansas Senator; son of David Pryor; lost 2014 Tom Cotton wave");
  I("Evan Bayh",              "Democrat","e7",["pm","chancellor","leader","defence"],        [55,58,52,55,52], "Democrat Indiana Senator; Governor; moderate Democrat; quit 2010 citing dysfunction");
  I("Mary Landrieu",          "Democrat","e7",["pm","energy","leader","home"],               [52,58,52,50,52], "Democrat Louisiana Senator; Katrina; energy hawkish; lost to Bill Cassidy");
  I("Kay Hagan",              "Democrat","e7",["pm","health","leader","work"],               [52,52,50,50,50], "Democrat North Carolina Senator; lost 2014; ACA-adjacent political victim");
  I("Mark Begich",            "Democrat","e7",["pm","leader","defence"],                     [50,52,48,48,48], "Democrat Alaska Senator; Anchorage Mayor; lost 2014 Sullivan wave");
  I("Mark Udall",             "Democrat","e7",["pm","environment","intelligence","leader"],  [55,55,52,52,50], "Democrat Colorado Senator; NSA whistleblower ally; lost 2014");
  I("Tom Udall",              "Democrat","e7",["pm","environment","leader"],                  [55,58,52,52,50], "Democrat New Mexico Senator; nephew of Mo Udall; clean elections champion");
  I("Sherrod Brown",          "Democrat","e7",["pm","work","trade","leader"],                [60,62,60,58,58], "Democrat Ohio Senator; Rust Belt progressive trade hawk; steel worker ally");
  I("Bob Casey Jr.",          "Democrat","e7",["pm","health","work","leader"],               [52,58,50,52,52], "Democrat Pennsylvania Senator; son of Governor; lost 2024");
  I("Gary Peters",            "Democrat","e7",["pm","commerce","leader"],                    [52,55,50,50,50], "Democrat Michigan Senator; DSCC chair 2020; military background");
  I("Tina Smith",             "Democrat","e7",["pm","health","agriculture","leader"],        [52,52,50,50,50], "Democrat Minnesota Senator; Planned Parenthood VP background");
  I("Tammy Baldwin",          "Democrat","e7",["pm","health","trade","leader"],              [56,55,54,52,52], "Democrat Wisconsin Senator; first openly gay Senator; healthcare champion");
  I("Tammy Duckworth",        "Democrat","e7",["pm","defence","leader","health"],            [60,55,58,55,52], "Democrat Illinois Senator; Iraq War double amputee; first birth on Senate floor");
  I("Mazie Hirono",           "Democrat","e7",["pm","education","leader","justice"],         [56,58,55,52,52], "Democrat Hawaii Senator; first Buddhist Senator; immigration champion");
  I("Ben Cardin",             "Democrat","e7",["pm","foreign","chancellor","leader"],        [52,62,50,52,52], "Democrat Maryland Senator; Cardin-Lugar extractives transparency");
  I("Chris Van Hollen",       "Democrat","e7",["pm","chancellor","foreign","leader"],        [52,55,50,52,50], "Democrat Maryland Senator; DSCC; budget committee; Johns Hopkins background");
  I("Martin Heinrich",        "Democrat","e7",["pm","energy","intelligence","leader"],       [52,52,50,50,48], "Democrat New Mexico Senator; mechanical engineer; intel committee");
  I("Brian Schatz",           "Democrat","e7",["pm","environment","commerce","leader"],      [54,52,52,52,50], "Democrat Hawaii Senator; climate finance champion; LG background");
  I("Sheldon Whitehouse",     "Democrat","e7",["pm","justice","environment","leader"],       [55,58,55,52,52], "Democrat Rhode Island Senator; climate time for whiteboard; dark money crusade");
  I("Jack Reed",              "Democrat","e7",["pm","defence","education","leader"],         [55,62,50,52,52], "Democrat Rhode Island Senator; West Point; Armed Services ranking member");
  ...
  I("Susan Collins",          "Republican","e7",["pm","health","leader","chancellor"],       [56,62,52,55,55], "Republican Maine Senator; most bipartisan Senator; Gang of Eight immigration");
  I("Lisa Murkowski",         "Republican","e7",["pm","energy","health","leader"],           [56,60,52,55,55], "Republican Alaska Senator write-in 2010; ACA vote no; Kavanaugh no; Trump acquit yes");
  I("Ben Sasse",              "Republican","e7",["pm","justice","education","leader"],       [55,52,55,52,50], "Republican Nebraska Senator; Trump critic; Nebraska Cornhuskers President");
  I("Jeff Flake",             "Republican","e7",["pm","leader","trade","chancellor"],        [54,55,52,52,50], "Republican Arizona Senator; Trump scourge; Flake Report on waste; quit 2018");
  I("Bob Corker",             "Republican","e7",["pm","foreign","chancellor","leader"],      [55,58,52,55,52], "Republican Tennessee Senator; called White House adult day care; resigned");
  I("John Thune",             "Republican","e7",["pm","leader","agriculture","trade"],       [52,62,50,52,55], "Republican Senate Majority Leader from 2025; South Dakota moderate");
  I("Rick Scott",             "Republican","e7",["pm","health","chancellor","leader"],       [48,55,48,45,48], "Republican Florida Governor; Medicare fraud; NRSC chair; 2024 Senate run");
  I("Ron Johnson",            "Republican","e7",["pm","leader","foreign"],                   [42,52,45,40,42], "Republican Wisconsin Senator; COVID conspiracist; China hawk");
  I("Tommy Tuberville",       "Republican","e7",["pm","defence","leader","education"],       [40,48,45,38,40], "Republican Alabama Senator; football coach; blocked military promotions a year");
  I("Eric Schmitt",           "Republican","e7",["pm","justice","leader"],                   [45,50,48,42,45], "Republican Missouri Senator; AG climate lawsuits; election denier");
  I("Ted Budd",               "Republican","e7",["pm","leader","justice"],                   [42,48,42,40,42], "Republican North Carolina Senator; gun shop owner; Trump loyalist");
  I("J.D. Vance",             "Republican","e7",["pm","deputy","leader","trade"],            [52,48,58,48,50], "Republican Vice President; Hillbilly Elegy; former Trump critic turned loyalist");
  I("Markwayne Mullin",       "Republican","e7",["pm","health","leader"],                    [45,48,45,42,42], "Republican Oklahoma Senator; UFC fan; challenged union leader to fight");
  I("Cynthia Lummis",         "Republican","e7",["pm","chancellor","leader"],                [48,52,45,46,46], "Republican Wyoming Senator; Bitcoin champion; first crypto senator");
  I("Mike Braun",             "Republican","e7",["pm","leader","health","chancellor"],       [48,52,45,44,46], "Republican Indiana Senator; businessman; Indiana Governor from 2025");
  I("Roger Marshall",         "Republican","e7",["pm","health","agriculture","leader"],      [42,50,42,40,42], "Republican Kansas Senator; OB/GYN; freedom caucus; farm state");
  I("Bill Hagerty",           "Republican","e7",["pm","foreign","trade","leader"],           [50,55,48,50,48], "Republican Tennessee Senator; Ambassador Japan; Trump fundraiser");
  I("Tom Cotton",             "Republican","e7",["pm","defence","foreign","leader"],         [50,52,52,50,50], "Republican Arkansas Senator; Iraq/Afghanistan veteran; hawkish interventionist");
  I("Joni Ernst",             "Republican","e7",["pm","defence","agriculture","leader"],     [50,52,48,48,50], "Republican Iowa Senator; 'I grew up castrating hogs'; military veteran");
  I("Thom Tillis",            "Republican","e7",["pm","justice","leader","work"],            [48,55,46,48,48], "Republican North Carolina Senator; immigration compromise attempts");
  I("Steve Daines",           "Republican","e7",["pm","energy","agriculture","leader"],      [48,52,45,46,46], "Republican Montana Senator; NRSC chair; tech background; hunting obsessive");
  I("James Lankford",         "Republican","e7",["pm","justice","home","leader"],            [48,52,48,46,48], "Republican Oklahoma Senator; border deal then blocked by Trump");
  I("Mike Rounds",            "Republican","e7",["pm","defence","chancellor","leader"],      [48,55,44,48,48], "Republican South Dakota Senator; Governor; pragmatic moderate");
  I("Jerry Moran",            "Republican","e7",["pm","health","agriculture","leader"],      [48,55,44,48,48], "Republican Kansas Senator; VA committee; farmer advocate");
  I("John Barrasso",          "Republican","e7",["pm","health","energy","leader"],           [48,55,44,46,48], "Republican Wyoming Senator; orthopaedic surgeon; environment opponent");
  I("Mike Crapo",             "Republican","e7",["pm","chancellor","agriculture","leader"],  [48,58,44,48,48], "Republican Idaho Senator; Finance committee ranking; LDS teetotaller DUI");
  I("James Risch",            "Republican","e7",["pm","foreign","intelligence","leader"],    [46,58,42,46,46], "Republican Idaho Senator; Foreign Relations; Trump loyalist");
  I("Pat Toomey",             "Republican","e7",["pm","chancellor","trade","leader"],        [52,58,50,52,50], "Republican Pennsylvania Senator; Club for Growth; Toomey amendment gun check");
  I("Rob Portman",            "Republican","e7",["pm","trade","chancellor","leader"],        [55,60,50,55,52], "Republican Ohio Senator; trade rep; gay marriage endorser; quit Senate 2022");
  I("Richard Burr",           "Republican","e7",["pm","health","intelligence","leader"],     [50,58,48,50,48], "Republican North Carolina Senator; intel chair; stock sell COVID probe");
  I("Tim Scott",              "Republican","e7",["pm","leader","work","chancellor"],         [58,55,58,52,55], "Republican South Carolina Senator; first Black Republican Senator South since Reconstruction; 2024 candidate");
  I("Roy Blunt",              "Republican","e6",["pm","health","leader","chancellor"],       [50,62,48,50,52], "Republican Missouri Senator; whip; appropriations; career pol");
  I("Mike Enzi",              "Republican","e6",["pm","health","chancellor","leader"],       [50,62,46,50,48], "Republican Wyoming Senator; shoe store owner; HELP committee; non-partisan");
  I("Johnny Isakson",         "Republican","e7",["pm","health","foreign","leader"],          [52,58,50,52,50], "Republican Georgia Senator; real estate; VA accountability; resigned ill 2019");
  I("Kelly Ayotte",           "Republican","e7",["pm","leader","justice","defence"],         [54,52,52,50,50], "Republican New Hampshire Senator; Attorney General; lost 2016; Governor from 2025");
  I("Joe Donnelly",           "Democrat","e7",["pm","defence","agriculture","leader"],       [50,52,48,50,48], "Democrat Indiana Senator; moderate; lost 2018 Braun wave");
  I("Heidi Heitkamp",         "Democrat","e7",["pm","agriculture","energy","leader"],        [52,52,50,50,50], "Democrat North Dakota Senator; former AG; pipeline opponent; lost 2018");
  I("Claire McCaskill",       "Democrat","e7",["pm","home","leader","defence"],              [56,60,58,54,55], "Democrat Missouri Senator; Air Guard pilot; lost to Hawley 2018");
  I("Phil Bredesen",          "Democrat","e7",["pm","health","leader","chancellor"],         [55,55,52,52,50], "Democrat Tennessee Governor; lost to Blackburn 2018");
  I("Andrew Gillum",          "Democrat","e7",["pm","leader","home"],                         [55,48,60,48,50], "Democrat Florida Governor candidate 2018; Tallahassee Mayor; scandal 2020");
  I("Stacy Abrams copy",      "Democrat","e7",["pm","leader","justice"],                     [60,50,62,50,52], "Democrat Georgia Governor candidate twice; voting rights pioneer");

  /* ═══════════════════════════════════════════════════════════════
     USA — GOVERNORS & HOUSE
     ═══════════════════════════════════════════════════════════════ */
  I("Jerry Brown",            "Democrat","e5",["pm","leader","environment","chancellor"],    [60,68,62,60,58], "Democrat California Governor twice (1975–83 and 2011–19); Moonbeam; climate pioneer");
  I("Arnold Schwarzenegger",  "Republican","e7",["pm","leader","environment","trade"],       [62,55,65,55,52], "Republican California Governor 2003–11; Terminator; climate moderate Republican");
  I("Pete Wilson",            "Republican","e6",["pm","leader","home","chancellor"],         [52,62,50,52,52], "Republican California Governor 1991–99; Prop 187; anti-immigrant reputation");
  I("George Deukmejian",      "Republican","e5",["pm","justice","home","leader"],            [50,60,48,50,50], "Republican California Governor 1983–91; prosecutor; fiscal conservative");
  I("Mike Bloomberg",         "Democrat","e7",["pm","chancellor","environment","leader"],    [58,60,55,58,52], "Republican→Democrat NYC Mayor; gun control; 2020 presidential candidate; $1 billion ad");
  I("Rudy Giuliani",          "Republican","e6",["pm","justice","home","leader"],            [55,62,60,52,52], "Republican NYC Mayor 9/11; RICO prosecutor; election fraud crusader; disbarred");
  I("Bill de Blasio",         "Democrat","e7",["pm","home","education","leader"],            [52,52,52,50,50], "Democrat NYC Mayor 2014–21; 2020 presidential one-percenter; tale of two cities");
  I("Andrew Cuomo",           "Democrat","e7",["pm","home","chancellor","leader"],           [52,62,52,52,55], "Democrat New York Governor 2011–21; COVID handling; nursing home deaths; #MeToo resignation");
  I("Kathy Hochul",           "Democrat","e7",["pm","leader","chancellor","health"],         [55,55,52,52,52], "Democrat New York Governor from 2021; Lt Governor succession; subway crime battles");
  I("Mario Cuomo",            "Democrat","e5",["pm","leader","chancellor","justice"],        [65,65,68,62,60], "Democrat New York Governor 1983–94; 1984 DNC keynote giant; never ran for President");
  I("Eliot Spitzer",          "Democrat","e7",["pm","justice","chancellor","leader"],        [55,58,60,52,52], "Democrat New York AG then Governor; 'Sheriff of Wall Street'; escort scandal");
  I("George Pataki",          "Republican","e6",["pm","leader","environment","chancellor"],  [52,60,50,52,50], "Republican New York Governor 1995–2006; 9/11 leadership; moderate");
  I("Charlie Baker",          "Republican","e7",["pm","leader","health","chancellor"],       [60,58,55,58,55], "Republican Massachusetts Governor 2015–23; most popular US Governor; moderate");
  I("Deval Patrick",          "Democrat","e7",["pm","justice","leader","home"],              [58,55,60,55,52], "Democrat Massachusetts Governor 2007–15; Obama clone; 2020 candidate");
  I("Kim Reynolds",           "Republican","e7",["pm","leader","chancellor","health"],       [50,52,48,50,50], "Republican Iowa Governor from 2017; Trump loyalist; school choice champion");
  I("Scott Walker",           "Republican","e7",["pm","work","leader","education"],          [50,55,48,50,52], "Republican Wisconsin Governor 2011–19; union buster; Act 10; recall survivor");
  I("Tony Evers",             "Democrat","e7",["pm","education","leader","chancellor"],      [52,52,50,52,50], "Democrat Wisconsin Governor from 2019; schools chief; battles Republican legislature");
  I("Ned Lamont",             "Democrat","e7",["pm","chancellor","trade","leader"],          [52,52,50,52,50], "Democrat Connecticut Governor from 2019; Lieberman challenger 2006; broadband");
  I("Phil Murphy",            "Democrat","e7",["pm","chancellor","leader","foreign"],        [52,52,50,52,50], "Democrat New Jersey Governor 2018–26; Goldman Sachs Ambassador Germany");
  I("Doug Murphy",            "Democrat","e7",["pm","leader","chancellor"],                  [50,50,48,50,48], "Democrat NJ");
  I("Ralph Northam",          "Democrat","e7",["pm","health","leader","environment"],        [50,52,50,50,48], "Democrat Virginia Governor 2018–22; physician; yearbook blackface scandal");
  I("Glenn Youngkin",         "Republican","e7",["pm","chancellor","education","leader"],    [52,50,52,52,50], "Republican Virginia Governor from 2022; Carlyle Group; school curriculum fights");
  I("Brian Kemp",             "Republican","e7",["pm","home","agriculture","leader"],        [50,52,48,50,50], "Republican Georgia Governor; election certifier opposed to Trump; Kemp vs Stacey Abrams");
  I("Henry McMaster",         "Republican","e7",["pm","justice","home","leader"],            [48,55,44,48,46], "Republican South Carolina Governor; first Trump endorser 2016; AG background");
  I("Roy Cooper",             "Democrat","e7",["pm","leader","justice","health"],            [55,55,52,52,52], "Democrat North Carolina Governor from 2017; AG; bathroom bill repeal");
  I("Andy Beshear",           "Democrat","e7",["pm","health","leader","justice"],            [58,52,58,52,52], "Democrat Kentucky Governor from 2019; son of Steve Beshear; pragmatic");
  I("Steve Bullock",          "Democrat","e7",["pm","leader","justice","environment"],       [55,52,52,52,50], "Democrat Montana Governor; 2020 presidential candidate; lost Senate race");
  I("Jay Nixon",              "Democrat","e7",["pm","justice","leader","chancellor"],        [52,58,50,52,50], "Democrat Missouri Governor 2009–17; AG background; Ferguson response criticized");
  I("Jay Inslee",             "Democrat","e7",["pm","environment","energy","leader"],        [56,58,56,54,52], "Democrat Washington Governor 2013–25; climate-only 2020 candidate; nuclear closure");
  I("Gary Locke",             "Democrat","e6",["pm","trade","leader","chancellor"],          [56,60,52,56,52], "Democrat Washington Governor; first Chinese-American Governor; Commerce Secretary");
  I("Mike Dunleavy",          "Republican","e7",["pm","leader","energy","chancellor"],       [46,50,44,46,46], "Republican Alaska Governor from 2018; oil state loyalist");
  ...
  I("Doug Ducey",             "Republican","e7",["pm","leader","chancellor","education"],    [50,55,48,50,50], "Republican Arizona Governor 2015–23; Goldwater Institute; Cold Stone CEO");
  I("Janet Napolitano",       "Democrat","e6",["pm","home","justice","leader"],              [58,60,55,58,55], "Democrat Arizona Governor; Homeland Security Secretary; UC system president");
  I("Kate Brown",             "Democrat","e7",["pm","environment","leader","justice"],       [52,52,50,52,50], "Democrat Oregon Governor 2015–23; first openly LGBT Governor in US history");
  I("Tina Kotek",             "Democrat","e7",["pm","home","health","leader"],               [52,50,50,50,50], "Democrat Oregon Governor from 2023; second openly LGBT US Governor; housing focus");
  I("Jay Inslee copy",        "Democrat","e7",["pm","environment","leader"],                 [55,56,54,52,50], "Democrat climate governor Washington");
  I("Steve Sisolak",          "Democrat","e7",["pm","chancellor","health","leader"],         [50,52,48,50,48], "Democrat Nevada Governor 2019–23; COVID closures; lost 2022 Lombardo wave");
  I("Joe Lombardo",           "Republican","e7",["pm","home","leader"],                      [50,50,48,48,48], "Republican Nevada Governor from 2023; Las Vegas Metro Sheriff");
  I("Michelle Lujan Grisham", "Democrat","e7",["pm","health","leader","environment"],        [55,55,52,52,52], "Democrat New Mexico Governor from 2019; Health Secretary candidate 2020");
  I("Lujan Grisham",          "Democrat","e7",["pm","health","leader"],                      [52,54,50,50,50], "New Mexico governor continuation");
  I("Laura Kelly",            "Democrat","e7",["pm","health","education","leader"],          [52,52,50,52,50], "Democrat Kansas Governor from 2019; state Senate veteran; won in deep red");
  I("Jared Polis",            "Democrat","e7",["pm","chancellor","education","leader"],      [58,52,58,55,52], "Democrat Colorado Governor from 2019; first openly gay elected Governor; internet entrepreneur");
  I("Spencer Cox",            "Republican","e7",["pm","health","agriculture","leader"],      [52,52,50,52,48], "Republican Utah Governor from 2021; Twitter civility champion; anti-Trump moderate");
  I("Mark Gordon",            "Republican","e7",["pm","energy","agriculture","leader"],      [48,50,44,46,46], "Republican Wyoming Governor from 2019; coal country pragmatist");
  I("Kristi Noem",            "Republican","e7",["pm","agriculture","home","leader"],        [48,52,50,44,48], "Republican South Dakota Governor; killed dog Cricket; Trump VP hopeful");
  I("Doug Burgum",            "Republican","e7",["pm","energy","chancellor","leader"],       [50,52,48,50,48], "Republican North Dakota Governor; Interior Secretary from 2025; tech businessman");
  I("Pete Ricketts",          "Republican","e7",["pm","chancellor","agriculture","leader"],  [48,55,44,46,46], "Republican Nebraska Governor; Cubs owner; death penalty restorer; Senator from 2023");
  I("Mike Parson",            "Republican","e7",["pm","agriculture","home","leader"],        [44,52,42,44,44], "Republican Missouri Governor from 2018; Sheriff background; Trump loyalist");
  I("Asa Hutchinson",         "Republican","e7",["pm","home","justice","leader"],            [52,58,50,52,50], "Republican Arkansas Governor 2015–23; DEA; Homeland; Trump 2024 rival");
  I("Sarah Huckabee Sanders", "Republican","e7",["pm","home","education","leader"],          [48,48,50,44,46], "Republican Arkansas Governor from 2023; Trump press secretary; abortion ban");
  I("Tate Reeves",            "Republican","e7",["pm","chancellor","health","leader"],       [44,50,42,44,44], "Republican Mississippi Governor from 2020; COVID response attacked; 2024");
  I("Brad Little",            "Republican","e7",["pm","agriculture","energy","leader"],      [46,52,42,46,46], "Republican Idaho Governor from 2019; rancher; Lt Governor under Otter");
  I("Greg Abbott",            "Republican","e7",["pm","justice","home","leader"],            [48,58,48,46,50], "Republican Texas Governor from 2015; wheelchair-bound; migrant busing; abortion ban");
  I("Gregg Abbott copy",      "Republican","e7",["pm","home","leader"],                     [46,56,46,44,48], "Republican Texas Governor continuation");
  I("Eric Holder",            "Democrat","e7",["pm","justice","leader"],                    [58,60,58,58,55], "Democrat Attorney General 2009–15; first Black AG; Fast & Furious; voting rights");
  I("Loretta Lynch",          "Democrat","e7",["pm","justice","leader","trade"],             [58,58,55,58,52], "Democrat Attorney General 2015–17; first Black woman AG; Clinton tarmac meeting");
  I("Janet Reno",             "Democrat","e6",["pm","justice","leader"],                    [55,62,52,55,52], "Democrat AG 1993–2001; first woman AG; Waco; Elián González; Ruby Ridge");
  I("William Barr",           "Republican","e6",["pm","justice","leader"],                   [45,62,45,45,45], "Republican AG 1991–93 and 2019–20; Mueller spin; resigned after election fraud rejection");
  I("Jeff Sessions",          "Republican","e7",["pm","justice","home","leader"],            [42,60,42,40,42], "Republican AG 2017–18; recused Russia; Trump fired him; Alabama Senate loss");
  I("Alberto Gonzales",       "Republican","e7",["pm","justice","leader"],                   [42,55,40,42,40], "Republican AG 2005–07; torture memos; fired US Attorneys; resigned");
  I("John Ashcroft",          "Republican","e6",["pm","justice","home","leader"],            [42,58,42,42,44], "Republican AG 2001–05; PATRIOT Act; lost Senate to dead man Carnahan");

  /* ═══════════════════════════════════════════════════════════════
     USA — HOUSE LEADERS
     ═══════════════════════════════════════════════════════════════ */
  I("Tip O'Neill",            "Democrat","e5",["pm","leader","chancellor"],                  [65,68,65,62,65], "Democrat Speaker 1977–87; 'All politics is local'; Reagan friend; Massachusetts titan");
  I("Jim Wright",             "Democrat","e5",["pm","leader","foreign"],                     [60,65,60,58,60], "Democrat Speaker 1987–89; ethics resignation; Fort Worth Texan; Nicaragua interest");
  I("Dick Gephardt",          "Democrat","e6",["pm","leader","trade","chancellor"],          [55,62,55,55,58], "Democrat House Majority Leader; trade hawk; 2004 presidential candidate; UAW favourite");
  I("Tom DeLay",              "Republican","e6",["pm","leader","home","chancellor"],         [40,62,45,40,48], "Republican Majority Leader 'The Hammer'; K Street Project; money laundering conviction");
  I("Dennis Hastert",         "Republican","e7",["pm","leader","education"],                 [38,60,38,38,42], "Republican Speaker 1999–2007; first longest-serving; child sexual abuse conviction");
  I("David Bonior",           "Democrat","e6",["pm","leader","work","foreign"],              [52,60,50,50,50], "Democrat Whip; Vietnam veteran; NAFTA opponent; peace activist");
  I("Steny Hoyer",            "Democrat","e6",["pm","leader","chancellor"],                  [50,68,50,50,55], "Democrat Majority Leader; Maryland; 40+ year career; Pelosi's rival turned deputy");
  I("Jim Jordan",             "Republican","e7",["pm","justice","leader","home"],            [40,52,50,36,46], "Republican House Judiciary Chair; Speaker attempt failed; Ohio wrestling coach");
  I("Mark Meadows",           "Republican","e7",["pm","home","leader","chancellor"],         [38,50,40,36,42], "Republican Freedom Caucus chair; Trump Chief of Staff; January 6 indictment");
  I("Mo Brooks",              "Republican","e7",["pm","leader","foreign"],                   [36,50,42,34,40], "Republican Alabama Rep; January 6 rally speech; armour under suit");
  I("Matt Gaetz",             "Republican","e7",["pm","justice","leader"],                   [42,48,52,36,40], "Republican Florida Rep; ousted McCarthy; sex trafficking allegations; no charges");
  I("Lauren Boebert",         "Republican","e7",["pm","home","leader"],                      [36,44,45,32,38], "Republican Colorado Rep; gun in cafeteria; theatre ejection; district switch");
  I("Marjorie Taylor Greene", "Republican","e7",["pm","leader","home"],                      [34,42,45,28,38], "Republican QAnon congresswoman; Jewish space lasers; stripped committees restored");
  I("Paul Gosar",             "Republican","e7",["pm","home","leader"],                      [32,50,38,28,36], "Republican Arizona Rep; family denounced him in ads; anime violence video censured");
  I("Andy Biggs",             "Republican","e7",["pm","justice","home","leader"],            [40,52,42,38,42], "Republican Arizona Rep; Freedom Caucus chair; election denier; January 6");
  I("Chip Roy",               "Republican","e7",["pm","home","justice","leader"],            [44,50,52,40,44], "Republican Texas Rep; Freedom Caucus; Ted Cruz ally; government shutdown champion");
  I("Dan Crenshaw",           "Republican","e7",["pm","defence","leader"],                   [52,50,55,48,48], "Republican Texas Rep; Navy SEAL; one-eyed veteran; moderate Freedom wing");
  I("Michael McCaul",         "Republican","e7",["pm","foreign","home","leader"],            [50,55,48,50,48], "Republican Texas Rep; Foreign Affairs Chair; homeland security hawk");
  I("Mike Turner",            "Republican","e7",["pm","defence","intelligence","leader"],    [50,55,48,50,48], "Republican Ohio Rep; Intel Chair; leaked Russia info warning 2024");
  I("Mike Rogers",            "Republican","e6",["pm","defence","intelligence","leader"],    [52,58,50,52,50], "Republican Michigan Rep; Intel Chair; armed teachers advocate");
  I("Adam Smith",             "Democrat","e7",["pm","defence","foreign","leader"],           [52,58,50,52,50], "Democrat Washington Rep; Armed Services ranking member; defence intellectual");
  I("Gregory Meeks",          "Democrat","e7",["pm","foreign","leader","finance"],           [50,58,50,50,50], "Democrat New York Rep; Foreign Affairs Chair; Queens Democratic boss");
  I("Brad Sherman",           "Democrat","e7",["pm","foreign","chancellor","leader"],        [50,58,50,50,48], "Democrat California Rep; Sherman Oaks CPA; financial services; India caucus");
  I("Brad Wenstrup",          "Republican","e7",["pm","health","defence","leader"],          [50,52,48,48,48], "Republican Ohio Rep; orthopedic surgeon; intelligence committee; Capitol Police support");
  I("Barbara Lee",            "Democrat","e6",["pm","foreign","leader"],                     [55,60,55,52,52], "Democrat California Rep; only vote against AUMF 2001; Senate candidate 2024");
  I("Maxine Waters",          "Democrat","e6",["pm","chancellor","justice","leader"],        [55,65,60,50,55], "Democrat California Rep; 'reclaim your time'; Impeach 45; financial services chair");
  I("John Lewis",             "Democrat","e5",["pm","justice","leader","transport"],         [70,65,72,62,60], "Democrat Georgia Rep; civil rights icon; good trouble; Bloody Sunday Selma; died 2020");
  I("Charles Rangel",         "Democrat","e5",["pm","chancellor","work","leader"],           [55,70,55,55,58], "Democrat New York Rep; Ways & Means chair; Harlem; Korea vet; tax troubles");
  I("Elijah Cummings",        "Democrat","e6",["pm","justice","leader"],                     [62,62,65,58,58], "Democrat Maryland Rep; Oversight chair; Baltimore; died 2019 midterm term");
  I("Eliot Engel",            "Democrat","e6",["pm","foreign","leader"],                     [50,65,50,50,50], "Democrat New York Rep; Foreign Affairs chair; lost primary to Jamaal Bowman 2020");
  I("Jerry McNerney",         "Democrat","e7",["pm","energy","education","leader"],          [50,52,48,50,48], "Democrat California Rep; wind energy engineer; STEM champion");
  I("Ro Khanna copy",         "Democrat","e7",["pm","trade","defence"],                      [58,50,60,52,50], "Democrat Silicon Valley progressive trade hawk");
  ...
  I("Gough Whitlam",           "ALP (AU)","e5",["pm","leader","chancellor","education"], [65,62,65,65,60], "ALP PM 1972–75; It's Time; dismissed by GG; Medicare; Medibank; free university");
  ...
  I("Bob Hawke",               "ALP (AU)","e5",["pm","leader","chancellor","work"],     [65,65,68,62,62], "ALP PM 1983–91; floating dollar; compulsory super; ACTU accord; popular larrikin");
  I("Paul Keating",            "ALP (AU)","e6",["pm","leader","chancellor","trade"],    [60,62,62,62,58], "ALP PM 1991–96; Banana Republic warning; recession we had to have; Asian engagement");
  ...
  I("Kevin Rudd",              "ALP (AU)","e7",["pm","leader","chancellor","foreign"],   [58,55,58,55,52], "ALP PM 2007–10, 2013; Sorry speech; GFC stimulus; ousted twice; UN Secretary-General bid");
  I("Julia Gillard",           "ALP (AU)","e7",["pm","leader","chancellor","education"], [62,55,62,60,55], "ALP first female PM; carbon tax; minority government; misogyny speech; ousted by Rudd");
  ...
  I("Anthony Albanese",        "ALP (AU)","e7",["pm","leader","chancellor","work"],      [55,55,55,55,55], "ALP PM from 2022; Climate change; Voice referendum loss; housing; AUKUS");
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════ */
  I("Franklin D. Roosevelt",   "Democratic (US)","e3",["pm","leader","chancellor","work"],[75,78,75,78,75], "FDR President 4x; New Deal; WWII; polio; Eleanor; Four Freedoms; Yalta; died in office");
  I("Harry S. Truman",         "Democratic (US)","e3",["pm","leader","foreign","defence"],[65,65,62,65,62], "Democratic President; A-bomb; NATO; Korean War; Marshall Plan; civil rights order");
  I("Dwight D. Eisenhower",    "Republican (US)","e3",["pm","leader","defence","foreign"],[65,72,60,68,62], "Republican President; D-Day; military-industrial complex warning; I-Like-Ike; NASA");
  I("John F. Kennedy",         "Democratic (US)","e4",["pm","leader","foreign","chancellor"],[72,60,75,68,62], "JFK; Bay of Pigs; Cuban Missile; Ich bin ein Berliner; assassinated 1963; Camelot");
  I("Lyndon B. Johnson",       "Democratic (US)","e4",["pm","leader","chancellor","work"],[60,65,60,58,62], "LBJ; Great Society; Civil Rights Act; Vietnam escalation; 'Great Society poverty war'");
  I("Richard Nixon",           "Republican (US)","e5",["pm","leader","foreign","chancellor"],[45,68,48,52,50], "Republican President; China opening; Watergate; Checkers speech; resigned 1974");
  I("Gerald Ford",             "Republican (US)","e5",["pm","leader","chancellor"],     [55,60,50,55,52], "Republican VP-become-President; Nixon pardon; fell down stairs; Helsinki Accords");
  I("Jimmy Carter",            "Democratic (US)","e5",["pm","leader","foreign","chancellor"],[60,62,58,60,55], "Democratic President; Camp David; Iran hostage; malaise speech; Habitat for Humanity");
  I("Ronald Reagan",           "Republican (US)","e5",["pm","leader","chancellor","foreign"],[68,65,72,62,65], "Republican President; Reaganomics; Cold War end; Iran-Contra; 'Tear down this wall'");
  I("George H.W. Bush",        "Republican (US)","e6",["pm","leader","foreign","chancellor"],[58,65,52,62,58], "Republican President; Gulf War; Berlin Wall; points of light; NAFTA signed");
  I("Bill Clinton",            "Democratic (US)","e6",["pm","leader","chancellor","trade"],[68,60,70,62,62], "Democratic President; NAFTA; balanced budget; Monica Lewinsky; DADT; Balkan peace");
  I("George W. Bush",          "Republican (US)","e7",["pm","leader","foreign","chancellor"],[48,60,48,45,50], "Republican President; 9/11; Iraq War; tax cuts; Katrina; TARP; Abu Ghraib");
  I("Barack Obama",            "Democratic (US)","e7",["pm","leader","chancellor","foreign"],[72,60,75,65,62], "Democratic 44th President; ACA; financial crisis; Nobel Peace; DACA; Syria redline");
  I("Donald Trump",            "Republican (US)","e7",["pm","leader","chancellor","trade"],[55,48,62,42,55], "Republican 45th/47th President; tariffs; Jan 6; convicted; MAGA; border wall; NATO threats");
  I("Joe Biden",               "Democratic (US)","e7",["pm","leader","foreign","chancellor"],[52,68,48,55,52], "Democratic 46th President; Ukraine; Inflation Reduction Act; withdrew 2024 run; oldest PM");
  I("Kamala Harris",           "Democratic (US)","e7",["pm","leader","justice","chancellor"],[55,52,55,52,52], "Democratic VP; 2024 candidate; CA AG; prosecutor; first female VP; word salads");
  I("Paul Ryan",               "Republican (US)","e7",["pm","chancellor","leader","work"],[52,52,52,50,52], "Republican Speaker; Ryan budget; Medicare reform; VP 2012; declined Trump endorsement");
  I("Nancy Pelosi",            "Democratic (US)","e7",["pm","leader","health","chancellor"],[60,68,58,60,65], "Democratic House Speaker twice; most powerful legislator; tore Trump speech; impeachments");
  I("Mitch McConnell",         "Republican (US)","e7",["pm","leader","justice","chancellor"],[38,68,38,45,62], "Republican Senate leader; Merrick Garland blockage; McConnell-Obama frozen faces; turtle");
  I("Chuck Schumer",           "Democratic (US)","e7",["pm","leader","chancellor"],     [48,62,50,48,55], "Democratic Senate Majority leader; IRA; infrastructure; NY; ambitious operator");
  I("Kevin McCarthy",          "Republican (US)","e7",["pm","leader","chancellor"],     [38,50,40,36,42], "Republican Speaker 2023; ousted by Matt Gaetz after 9 months; Trump's man");
  I("Jim Jordan",              "Republican (US)","e7",["pm","leader","justice","home"],  [32,50,48,28,42], "Republican MAGA; House Judiciary; Speaker failed three times; Ohio wrestling coach");
  I("Alexandria Ocasio-Cortez","Democratic (US)","e7",["pm","leader","work","environment"],[65,45,68,52,52], "AOC; Democratic Socialist; Bronx bartender; Green New Deal; 'The Squad'; youngest");
  I("Bernie Sanders",          "Democratic (US)","e7",["pm","leader","work","health"],  [65,65,70,58,52], "Independent-Democratic Socialist; Medicare for All; Free College; 2016/2020 runs");
  ...
  I("Abraham Lincoln",         "Republican (US)","e1",["pm","leader","justice","chancellor"],[72,65,75,72,65], "Republican President; Civil War; Emancipation; Gettysburg; Ford's Theatre assassination");
  ...
  I("Martin Luther King Jr",   "Democratic (US)","e4",["pm","leader","work","justice"],  [78,55,82,68,62], "Civil rights; 'I Have a Dream'; Montgomery Bus Boycott; Nobel Peace 1964; assassinated 1968");
  ...
  I("Eugene V. Debs",          "Democratic (US)","e2",["pm","leader","work","justice"],  [62,55,68,58,50], "Socialist Party 5x presidential candidate; Eugene Debs; imprisoned for anti-war; 'While there is a lower class'");
  I("Frederick Douglass",      "Republican (US)","e1",["pm","leader","justice","foreign"],[72,55,78,65,58], "Abolitionist; escaped slave; North Star; civil rights; orator; diplomat; women's suffrage ally");
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════ */
  I("Hubert Humphrey",         "Democratic (US)","e4",["pm","foreign","leader","work"],  [62,65,62,60,58], "Democratic VP; 1968 candidate; civil rights champion; 'Happy Warrior'");
  I("Barry Goldwater",         "Republican (US)","e4",["pm","leader","chancellor","defence"],[55,62,55,52,52], "Republican 1964 candidate; AuH2O; libertarian conservatism; anti-civil rights vote");
  I("George Wallace",          "Democratic (US)","e4",["pm","leader","home","chancellor"],[38,55,45,32,42], "Alabama Governor; 'Segregation forever'; third party 1968; shot 1972; later recanted");
  I("Eugene McCarthy",         "Democratic (US)","e4",["pm","leader","foreign","work"], [58,60,62,55,48], "Democratic senator; anti-Vietnam challenge to LBJ; '68 New Hampshire; literary politician");
  I("Robert F. Kennedy",       "Democratic (US)","e4",["pm","leader","justice","foreign"],[65,58,68,60,58], "Democratic AG; NY Senator; 1968 California primary winner; assassinated June 5 1968");
  I("George McGovern",         "Democratic (US)","e5",["pm","leader","foreign","chancellor"],[60,62,60,58,50], "Democratic 1972 Nixon landslide loser; anti-war; WWII pilot; liberal icon");
  I("Walter Mondale",          "Democratic (US)","e5",["pm","leader","chancellor","work"],[55,62,52,55,52], "Democratic 1984 candidate; Geraldine Ferraro VP pick; 49-state loss; honest on taxes");
  I("Michael Dukakis",         "Democratic (US)","e6",["pm","leader","chancellor","home"],[52,58,50,52,50], "Democratic 1988 candidate; tank photo; 10-point lead squandered; Massachusetts technocrat");
  ...
  I("John Kerry",              "Democratic (US)","e7",["pm","foreign","leader","chancellor"],[55,62,55,55,52], "Democratic 2004 candidate; Vietnam vet; Swift Boat; Secretary of State; Iran deal; climate envoy");
  I("John McCain",             "Republican (US)","e7",["pm","leader","foreign","defence"],[62,65,62,60,55], "Republican 2008 candidate; POW; maverick; thumbs down ACA; died 2018; honored both sides");
  I("Sarah Palin",             "Republican (US)","e7",["pm","leader","home","energy"],   [48,42,52,36,42], "Republican VP 2008; Alaska Governor; Tea Party; death panels; Tina Fey; quit governorship");
  I("Mitt Romney",             "Republican (US)","e7",["pm","leader","chancellor","trade"],[55,58,52,55,52], "Republican 2012 candidate; Bain Capital; 47%; ACA original; anti-Trump senator");
  I("Elizabeth Warren",        "Democratic (US)","e7",["pm","leader","chancellor","work"],[62,60,62,58,52], "Democratic Senator; consumer bureau; wealth tax; 'nevertheless she persisted'; Native claim");
  I("Pete Buttigieg",          "Democratic (US)","e7",["pm","leader","foreign","transport"],[58,45,60,52,50], "Democratic Transportation Secretary; South Bend Mayor; 'Mayor Pete'; McKinsey; first gay cabinet");
  I("Beto O'Rourke",           "Democratic (US)","e7",["pm","leader","chancellor"],     [55,45,62,48,48], "Democratic TX Senate near-miss 2018; 2020 candidate; AR-15 buyback; 2022 governor loss");
  I("Tulsi Gabbard",           "Republican (US)","e7",["pm","leader","foreign","defence"],[50,45,55,44,44], "Rep DNI; D then R; Assad visit; Gabbard-style anti-war; Hindu American; NBC host");
  I("Mike Pence",              "Republican (US)","e7",["pm","leader","home","chancellor"],[42,55,45,40,48], "Republican VP; 2024 candidate withdrawal; evangelical; Jan 6 certified; Indiana Governor");
  I("Ron DeSantis",            "Republican (US)","e7",["pm","leader","home","chancellor"],[45,50,48,42,48], "Republican Florida Governor; Don't Say Gay; 2024 candidate collapsed; CRT; woke capital");
  I("Vivek Ramaswamy",         "Republican (US)","e7",["pm","leader","chancellor","trade"],[50,40,58,44,45], "Republican 2024 candidate; biotech; DOGE co-head; 'woke' corporate critique; fast talker");
  I("Nikki Haley",             "Republican (US)","e7",["pm","leader","foreign","chancellor"],[52,52,52,50,50], "Republican SC Governor; UN Ambassador; 2024 race; 'Never Trump' then endorsed");
  I("Chris Christie",          "Republican (US)","e7",["pm","leader","home","chancellor"],[48,52,50,46,48], "Republican NJ Governor; Bridgegate; 2016/2024 race; Trump critic; COVID bridge");
  I("Ted Cruz",                "Republican (US)","e7",["pm","leader","justice","chancellor"],[42,55,48,38,45], "Republican TX Senator; 2016 primary runner-up; Cancun flight; filibuster Green Eggs");
  I("Marco Rubio",             "Republican (US)","e7",["pm","leader","foreign","chancellor"],[50,52,52,48,50], "Republican FL Senator; 2016 candidate; 'Liddle Marco'; Secretary of State 2025");
  I("Josh Hawley",             "Republican (US)","e7",["pm","leader","justice","home"],  [38,48,45,34,40], "Republican MO Senator; fist pump Jan 6; MAGA; anti-tech; Yale Law");
  I("JD Vance",                "Republican (US)","e7",["pm","leader","chancellor","foreign"],[48,42,52,40,44], "Republican VP 2025; Hillbilly Elegy; Ohio Senator; Thiel funding; America First");
  I("Gavin Newsom",            "Democratic (US)","e7",["pm","leader","chancellor","health"],[58,52,60,54,52], "Democratic CA Governor; 2028 potential; healthcare; homelessness; debate Trump");
  I("Gretchen Whitmer",        "Democratic (US)","e7",["pm","leader","chancellor","health"],[58,50,58,54,52], "Democratic MI Governor; kidnapping plot; 'fix the damn roads'; future president talk");
  ...
  I("Andrew Jackson",          "Democratic (US)","e0",["pm","leader","home","defence"],  [50,62,58,45,55], "Democratic 7th President; Indian Removal; Bank war; 'Old Hickory'; spoils system");
  ...
  I("Ulysses S. Grant",        "Republican (US)","e1",["pm","leader","defence","foreign"],[50,60,45,50,48], "Republican President; Civil War general; Reconstruction; corruption scandals; 'Unconditional Surrender'");
  I("Theodore Roosevelt",      "Republican (US)","e2",["pm","leader","chancellor","foreign"],[68,62,70,65,60], "Republican President; Rough Rider; Panama Canal; Nobel Peace; trust-buster; 'Speak softly'");
  I("Woodrow Wilson",          "Democratic (US)","e2",["pm","leader","foreign","chancellor"],[60,62,62,62,55], "Democratic President; 14 Points; League of Nations; Versailles; segregationist; Princeton");
  I("Herbert Hoover",          "Republican (US)","e2",["pm","chancellor","trade","leader"],[48,62,45,48,45], "Republican President; Depression architect; Great Engineer; Hoovervilles; Belgian relief");
  ...
  I("James K. Polk",           "Democratic (US)","e0",["pm","leader","foreign","chancellor"],[55,58,50,55,52], "Democratic 11th President; Oregon; Mexican War; manifest destiny; one-term pledge kept");
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════ */
  I("Steny Hoyer",             "Democratic (US)","e7",["pm","leader","chancellor"],     [48,65,45,48,52], "Democratic House majority leader; Maryland; Pelosi ally; long-tenured institution");
  I("James Clyburn",           "Democratic (US)","e7",["pm","leader","work","chancellor"],[55,62,52,52,55], "Democratic SC whip; civil rights veteran; Biden endorsement turned 2020 race");
  I("Hakeem Jeffries",         "Democratic (US)","e7",["pm","leader","justice","chancellor"],[55,50,55,52,52], "Democratic minority leader; Brooklyn; generational change; hip-hop references");
  I("Marjorie Taylor Greene",  "Republican (US)","e7",["pm","leader","home"],           [22,42,45,18,32], "QAnon Republican; Jewish space lasers; Georgia; censured; MTG; MAGA figurehead");
  I("Matt Gaetz",              "Republican (US)","e7",["pm","leader","home"],           [28,42,48,22,30], "Republican FL; vacated McCarthy speakership; alleged sex trafficking; AG nominee/withdrew");
  I("Lori Lightfoot",          "Democratic (US)","e7",["pm","leader","home","chancellor"],[45,48,50,42,42], "Democratic Chicago Mayor 2019–23; COVID; crime; became first big-city mayor to lose reelect");
  I("Muriel Bowser",           "Democratic (US)","e7",["pm","leader","chancellor"],     [50,50,48,50,50], "Democratic DC Mayor; Jan 6 before; racial equity; DC Statehood advocate");
  I("Greg Abbott",             "Republican (US)","e7",["pm","leader","home","chancellor"],[40,52,45,38,45], "Republican Texas Governor; Operation Lone Star; wheelchair user; migrant buses; disaster response");
  I("Glenn Youngkin",          "Republican (US)","e7",["pm","leader","chancellor","education"],[48,48,48,46,46], "Republican Virginia Governor; education; COVID schools; 2024 interest fizzled; Carlyle");
  I("Tim Scott",               "Republican (US)","e7",["pm","leader","chancellor"],     [50,50,50,48,48], "Republican SC Senator; first Black senator from South; 2024 candidate dropped; VP shortlist");
  I("Raphael Warnock",         "Democratic (US)","e7",["pm","leader","work","justice"], [58,50,60,52,50], "Democratic GA Senator; Ebenezer Baptist Church; MLK pulpit; defeated Herschel Walker");
  I("Jon Ossoff",              "Democratic (US)","e7",["pm","leader","chancellor"],     [52,45,52,50,48], "Democratic GA Senator; youngest at 33; documentary filmmaker; Perdue defeated");
  I("Katie Porter",            "Democratic (US)","e7",["pm","chancellor","justice","leader"],[58,48,60,54,48], "Democratic CA; whiteboard; consumer protection; Senate race 2024; Warren mentee");
  I("Dean Phillips",           "Democratic (US)","e7",["pm","leader","chancellor"],     [48,48,48,46,44], "Democratic MN; 2024 Biden primary challenger; ice cream fortune; dropped out"); 
  I("Marianne Williamson",     "Democratic (US)","e7",["pm","leader","culture","health"],[50,45,55,44,42], "Democratic spiritual author; love-based campaign; Department of Peace; 2020/2024 runs");
  I("Larry Hogan",             "Republican (US)","e7",["pm","leader","chancellor","health"],[52,52,50,50,50], "Republican MD Governor; Never Trump; 2024 Senate loss; moderate bipartisan brand");
  I("Charlie Baker",           "Republican (US)","e7",["pm","leader","chancellor","health"],[55,52,50,52,50], "Republican MA Governor; blue state moderate; high approval; NCAA President");
  I("Jay Inslee",              "Democratic (US)","e7",["pm","leader","environment","chancellor"],[55,52,52,52,50], "Democratic WA Governor; 2020 climate candidate; single issue; wind energy");
  I("John Hickenlooper",       "Democratic (US)","e7",["pm","leader","chancellor","trade"],[52,52,50,52,50], "Democratic CO Senator; brewer Governor; 2020 candidate late drop; bipartisan");
  I("Michael Bloomberg",       "Democratic (US)","e7",["pm","leader","chancellor","trade"],[52,58,48,52,50], "Democratic NYC Mayor 3x; billionaire 2020 race; stop and frisk; gun control; Super Tuesday drop");
  ...
  /* --- More USA Icons --- */
  I("Shirley Chisholm",        "Democratic (US)","e5",["pm","leader","work","education"],[65,55,65,58,52], "Democratic first Black congresswoman; first Black woman and first major woman presidential candidate 1972");
  I("Jesse Jackson",           "Democratic (US)","e6",["pm","leader","work","foreign"], [62,58,70,55,52], "Democratic Rainbow Coalition; 1984/1988 presidential runs; civil rights Chicago minister");
  I("Al Gore",                 "Democratic (US)","e7",["pm","leader","foreign","chancellor"],[60,62,55,60,55], "Democratic VP; 2000 Florida recount loser; An Inconvenient Truth; Nobel Peace 2007; Internet");
  I("Howard Dean",             "Democratic (US)","e7",["pm","leader","health","chancellor"],[55,52,60,52,50], "Democratic 2004 candidate; DNC Chair; Vermont Governor; Yeehaw scream; 50-state strategy");
  I("Wesley Clark",            "Democratic (US)","e7",["pm","leader","defence","foreign"],[58,60,52,58,50], "NATO Supreme Commander; Democratic 2004 candidate; Rhodes Scholar; Kosovo campaign");
  I("Dennis Kucinich",         "Democratic (US)","e6",["pm","leader","work","foreign"], [55,55,60,50,45], "Democratic Cleveland Mayor; peace dept; 2004/2008 candidate; anti-war socialist; vegan");
  I("Jerry Brown",             "Democratic (US)","e6",["pm","leader","environment","chancellor"],[60,65,60,58,52], "Democratic CA Governor twice; 'Governor Moonbeam'; solar; 1992 presidential; Oakland Mayor");
  I("Huey Long",               "Democratic (US)","e3",["pm","leader","work","chancellor"],[62,55,70,52,58], "Democratic Louisiana Governor then Senator; 'Every Man a King'; Share Our Wealth; assassinated 1935");
  I("George Marshall",         "Republican (US)","e3",["pm","defence","foreign","chancellor"],[65,70,60,68,60], "General; Secretary of State; Marshall Plan; Nobel Peace 1953; WW2 architect; non-partisan");
  I("Condoleezza Rice",        "Republican (US)","e7",["pm","foreign","leader","chancellor"],[58,62,55,60,55], "Republican Secretary of State 2005–09; NSA; Iraq 'mushroom cloud'; Stanford Provost; pianist");
  I("Colin Powell",            "Republican (US)","e7",["pm","foreign","defence","leader"],[62,65,60,65,58], "Republican Secretary of State 2001–05; UN WMD speech; NSA; Gulf War; CJCS; died 2021");
  I("Dick Cheney",             "Republican (US)","e7",["pm","defence","leader","chancellor"],[30,65,35,30,45], "Republican VP; Halliburton; Iraq War architect; 'dark side'; shot friend hunting; Wyoming");
  I("Donald Rumsfeld",         "Republican (US)","e7",["pm","defence","leader"],        [38,65,40,35,42], "Republican Defence Secretary twice; 'unknown unknowns'; Abu Ghraib; Iraq mismanagement");
  I("Henry Kissinger",         "Republican (US)","e5",["pm","foreign","chancellor","defence"],[55,72,55,62,52], "NSA then Secretary of State; Nobel Peace Vietnam 1973; détente; realpolitik; Chile coup support; died 2023");
  I("Zbigniew Brzezinski",     "Democratic (US)","e5",["pm","foreign","defence","chancellor"],[58,68,55,65,52], "NSA Carter; Grand Chessboard; Afghan mujahideen support; strategic competition");
  ...
  I("William Jennings Bryan",  "Democratic (US)","e1",["pm","leader","work","foreign"], [62,58,72,55,55], "Democratic 3x candidate; Cross of Gold; anti-imperialist; Scopes trial prosecution; pacifist");
  I("Adlai Stevenson II",      "Democratic (US)","e3",["pm","leader","foreign","chancellor"],[62,62,60,62,55], "Democratic 1952/1956 Eisenhower loser; UN Ambassador; eloquent intellectual; 'Egg head'");
  I("George H.W. Bush early",  "Republican (US)","e5",["pm","leader","foreign","chancellor"],[57,64,50,61,57], "Republican CIA Director; VP eight years; diplomat; Texas Congressman; preppy patrician");
  I("Jeb Bush",                "Republican (US)","e7",["pm","leader","chancellor","education"],[48,52,48,46,48], "Republican FL Governor; 2016 'low energy'; Common Core; 'please clap'; Bush dynasty fatigue");
  I("Eric Holder",             "Democratic (US)","e7",["pm","justice","leader","chancellor"],[52,58,50,52,50], "Democratic AG 2009–15; first Black AG; 'nation of cowards'; Fast and Furious; voting rights");
  I("Tom Cotton",              "Republican (US)","e7",["pm","leader","defence","foreign"],[38,50,45,35,40], "Republican AR Senator; military; Iran hardline; NYT op-ed controversy; 2024 interest faded");
  I("Glenn Beck",              "Republican (US)","e7",["pm","leader","culture","home"],   [30,42,48,24,32], "Media-political influencer; Tea Party; TheBlaze; chalkboard; 9/12 project; polariser");
  I("Ron Paul",                "Republican (US)","e6",["pm","leader","chancellor","foreign"],[55,58,55,52,45], "Republican libertarian; End the Fed; 2008/2012 runs; gold standard; anti-war republican");
  ...
  I("Hubert Humphrey extra",   "Democratic (US)","e4",["pm","foreign","work","leader"],  [61,64,61,59,57], "Humphrey continued — Medicare/Medicaid architect; 'Happy Warrior' Senate legacy");
