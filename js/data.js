...
G.ROSTER_2024 = [
  ...
  P("Keir Starmer",        "Labour",            "e24", ["pm","leader","justice"],     [60,72,60,82,66], "Led Labour to a landslide majority in 2024; former Director of Public Prosecutions.", "p24"),
  P("Rachel Reeves",       "Labour",            "e24", ["chancellor","business"],     [58,70,60,78,58], "Became the first woman Chancellor of the Exchequer in 2024.", "p24"),
  P("Angela Rayner",       "Labour",            "e24", ["deputy","education","home"],  [72,62,68,62,70], "Deputy Prime Minister and Labour's deputy leader after 2024.", "p24"),
  P("David Lammy",         "Labour",            "e24", ["foreign","justice"],          [66,66,72,68,58], "Foreign Secretary in the 2024 government.", "p24"),
  P("Yvette Cooper",       "Labour",            "e24", ["home","justice"],             [58,76,60,74,58], "Long-serving senior figure; Home Secretary from 2024.", "p24"),
  P("John Healey",         "Labour",            "e24", ["defence","business"],         [54,72,56,72,58], "Defence Secretary in the 2024 government.", "p24"),
  P("Wes Streeting",       "Labour",            "e24", ["health","leader"],            [68,60,72,64,58], "Health and Social Care Secretary from 2024.", "p24"),
  P("Bridget Phillipson",  "Labour",            "e24", ["education","chancellor"],     [58,62,62,68,56], "Education Secretary in the 2024 government.", "p24"),
  P("Shabana Mahmood",     "Labour",            "e24", ["justice","home"],             [56,64,62,70,56], "Lord Chancellor and Justice Secretary from 2024.", "p24"),
  P("Jonathan Reynolds",   "Labour",            "e24", ["business","chancellor"],      [56,62,60,66,56], "Business and Trade Secretary from 2024.", "p24"),
  P("Ed Miliband",         "Labour",            "e24", ["environment","leader"],       [58,74,66,66,54], "Energy Security and Net Zero Secretary; former Labour leader.", "p24"),
  P("Liz Kendall",         "Labour",            "e24", ["work","health"],              [54,62,58,64,54], "Work and Pensions Secretary from 2024.", "p24"),
  P("Pat McFadden",        "Labour",            "e24", ["whip","leader","business"],   [50,74,58,72,68], "Senior Cabinet Office minister and campaign coordinator.", "p24"),
  P("Zarah Sultana",       "Labour",            "e24", ["culture","education"],        [62,42,68,50,46], "Elected for Coventry South in 2024, sitting as Labour that year.", "p24"),
  ...
  P("Kemi Badenoch",       "Conservative",      "e24", ["business","leader"],          [62,58,68,62,58], "Senior Conservative; became party leader after 2024.", "p24"),
  P("James Cleverly",      "Conservative",      "e24", ["foreign","home"],             [60,64,62,64,58], "Former Foreign Secretary and Home Secretary.", "p24"),
  P("Priti Patel",         "Conservative",      "e24", ["home","defence"],             [52,64,56,58,56], "Former Home Secretary.", "p24"),
  P("Suella Braverman",    "Conservative",      "e24", ["justice","home"],             [50,56,60,56,48], "Former Home Secretary and Attorney General.", "p24"),
  /* Other parties */
  P("Ed Davey",            "Liberal Democrat",  "e24", ["deputy","leader","business"], [60,66,58,62,62], "Liberal Democrat leader; the party made major gains in 2024.", "p24"),
  P("Nigel Farage",        "Reform UK",         "e24", ["leader","foreign"],           [74,58,78,52,56], "Reform UK leader, elected MP for Clacton in 2024.", "p24"),
  P("Carla Denyer",        "Green",             "e24", ["environment","leader"],       [58,48,64,52,54], "Green Party co-leader, elected in 2024.", "p24"),
  P("Adrian Ramsay",       "Green",             "e24", ["environment","business"],     [52,50,56,54,54], "Green Party co-leader, elected in 2024.", "p24"),
  P("Stephen Flynn",       "SNP",               "e24", ["leader","foreign"],           [60,56,68,58,58], "SNP Westminster leader.", "p24"),
  /* The independent note the brief calls out */
  P("Jeremy Corbyn",       "Independent",       "e24", ["leader","foreign","justice"], [60,72,66,58,46], "Re-elected for Islington North in 2024 as an Independent.", "p24")
];
